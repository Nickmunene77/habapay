...
import 'package:haba/deposit_module/next_wallet_after_splash.dart';
...
class WalletSplashScreen extends StatefulWidget {
  ...
  @override
  WalletSplashScreenState createState() => WalletSplashScreenState();
}

class WalletSplashScreenState extends State<WalletSplashScreen> {
  @override
  void initState() {
    super.initState();
    Timer(const Duration(seconds: 1), () {
      Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) => const NextWalletSplashScreen()));
    });
  }
