...
class LinkCopiedSplash extends StatefulWidget {
  const LinkCopiedSplash({Key? key}) : super(key: key);

  @override
  LinkCopiedSplashState createState() => LinkCopiedSplashState();
}

class LinkCopiedSplashState extends State<LinkCopiedSplash> {
  @override
  void initState() {
    super.initState();
    Timer(const Duration(seconds: 2), () {
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => const ShareLinkScreen()));
    });
  }
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                              ...
                              child: const Row(
                                children: [
                                  Image(
                                    image: AssetImage('assets/Vector (20).png'),
                                  ),
                                  Center(
                                    child: Text(
