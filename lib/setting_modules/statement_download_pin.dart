...
import 'package:haba/setting_modules/statement_download_splash.dart';
import 'package:haba/widgets/account_bottom_bar.dart';

class StatementDownloadPin extends StatefulWidget {
  const StatementDownloadPin({Key? key}) : super(key: key);

  @override
  StatementDownloadPinState createState() => StatementDownloadPinState();
}

class StatementDownloadPinState extends State<StatementDownloadPin> {
  List<int> pinDigits = [];
  ...
  void _navigateToHomeScreen() {
    if (isPinComplete) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => StatementDownloadSplashScreen(),
        ),
      );
    } else {
      showDialog(
